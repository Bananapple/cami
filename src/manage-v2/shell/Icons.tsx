...
// Mirrors src/_design/screens/Icons.jsx for the v2 nav rail.
...
export function NavIcon({ name, size = 14 }: { name: IconName; size?: number }) {
  const props = {
    width: size,
    height: size,
    viewBox: "0 0 16 16",
    ...
    case "clients":
      return (
        <svg {...props}>
          ...
          <path d="M2.5 13.5c.4-2 1.7-3.2 3.5-3.2s3.1 1.2 3.5 3.2" />
          <circle cx="11.2" cy="5.8" r="1.6" />
          <path d="M10 9.5c.6-.5 1.1-.7 2-.7 1.4 0 2.5 1 2.8 2.5" />
        </svg>
      );
    case "studio":
      return (
        <svg {...props}>
          ...
          <path d="M8 1.8v2M8 12.2v2M14.2 8h-2M3.8 8h-2M12.4 3.6l-1.4 1.4M5 11l-1.4 1.4M12.4 12.4L11 11M5 5L3.6 3.6" />
        </svg>
      );
    case "search":
      return (
